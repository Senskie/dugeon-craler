controller.up.onEvent(ControllerButtonEvent.Pressed, function () {
    ridder_ofzo.setImage(img`
        ...
        . f 4 4 f f 6 6 f f 4 4 f . . . 
        f f 4 5 4 4 f f 4 4 5 4 f f . . 
        f f 4 5 5 5 4 4 5 5 5 5 f 9 f . 
...
controller.down.onEvent(ControllerButtonEvent.Pressed, function () {
    ridder_ofzo.setImage(img`
        ...
        . f f 4 f b f 3 3 f b f 4 f f . 
        . f 5 f d 1 f d d f 1 d f 5 f . 
        . . f d d d d d d d d d d f . . 
        . . . f d d d d d d d d f f . . 
        . . f f f f f f f f f f 9 f . . 
        . . f d f 6 6 6 9 9 6 f 6 f . . 
        . . . f f 4 4 5 5 4 4 f 6 f . . 
        . . . . . f f f f f f f 6 f . . 
        . . . . . f f . . f f . f . . . 
        `)
    controller.moveSprite(ridder_ofzo)
...
info.setLife(3)
pause(500)
music.playMelody("E D G F B A B C5 ", 120)
